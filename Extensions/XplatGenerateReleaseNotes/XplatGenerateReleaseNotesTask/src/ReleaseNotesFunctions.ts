...
export async function generateReleaseNotes(
    ...
    recursivelyCheckConsumedArtifacts: boolean,
): Promise<number> {
            ...
            if ((releaseId === undefined) || !releaseId) {
                ...
                if (checkStage) {
                    ...
                    if (lastGoodBuildId !== 0) {
                        ...
                        if (recursivelyCheckConsumedArtifacts) {
                            agentApi.logInfo("Recursively checking consumed artifacts for changes in the consumed artifacts");

...
### V2.x.x
This version provides cost platform support using the new .NET6 based [version 4.0.0 of AzureDevOps.WikiPDFExport](https://github.com/MaxMelcher/AzureDevOps.WikiPDFExport/releases/tag/4.0.3), and hence supports Windows, Linux and Mac usage via the Azure DevOps Pipeline Agent 2.x (Node10) or V3 (Node16) execution engines.
